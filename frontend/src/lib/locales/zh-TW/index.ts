export const zhTW = {
  ...
  connectionErrors: {
    ...
    apiDesc: "無法存取 Marinheiro de Silício API 伺服器",
    dbTitle: "資料庫連線失敗",
    ...
    docLink: "Marinheiro de Silício 文件",
  ...
  sources: {
    ...
    confirmAddToNotebook: "新增 {count} 個到此筆記本",
    added: "已新增於 {date}",
    addUrl: "新增 URL",
    uploadFile: "上傳檔案",
    enterText: "輸入文字",
  ...
  chat: {
    ...
    messageSources: "使用的來源",
    deleteMessageDesc: "確定要刪除此訊息嗎？刪除您的訊息也會刪除助手的回覆。此操作無法撤銷。",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Marinheiro de Silício 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "設定用於 Marinheiro de Silício 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有這些模型，Marinheiro de Silício 可能無法正常運行。",
    ...
    visionModelDesc: "用於圖像和影片描述 - 推薦 GPT-4o、Claude 或 Gemini",
  ...
  apiKeys: {
    ...
    description: "將 API 金鑰安全地儲存在資料庫中，以在 Marinheiro de Silício 中啟用 AI 服務商。",
