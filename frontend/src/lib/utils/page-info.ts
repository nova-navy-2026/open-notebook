...
const ptPT: PageInfoMap = {
  chat: {
    ...
    items: [
      ...
      'Anexe imagens ou vídeo e escolha modo visual: Auto, Descrever, OCR, Detetar ou Seguir.',
      'Anexe áudio ou vídeo para transcrição automática com identificação de falantes.',
      'Anexe CSV, TSV, TXT tabular, Excel, JSON, JSONL ou NDJSON para perfilar dados ou gerar gráficos inline.',
      'Audite fontes e evidência com o agente de qualidade de fontes — ele sinaliza claims sem suporte, lacunas e contradições.',
      'Peça para ser guiado passo a passo num procedimento — o agente de acompanhamento guia-o até ao fim.',
      'Ative a Deep Research para relatórios autónomos: o progresso e o relatório final aparecem no chat e ficam no histórico.',
      'Guarde respostas, tabelas ou relatórios como nota num notebook com "Save to note" e título opcional.',
...
const enUS: PageInfoMap = {
  chat: {
    ...
    items: [
      ...
      'Attach images or video and choose a visual mode: Auto, Describe, OCR, Detect or Track.',
      'Attach audio or video for automatic transcription with speaker identification.',
      'Attach CSV, TSV, tabular TXT, Excel, JSON, JSONL or NDJSON to profile data or generate inline charts.',
      'Audit sources and evidence with the source-quality agent — it flags unsupported claims, gaps and contradictions.',
      'Ask to be guided step by step through a procedure — the procedure agent walks you through to completion.',
      'Enable Deep Research for autonomous reports: progress and the final report appear in chat and stay in history.',
      'Save answers, tables or reports as notebook notes with "Save to note" and an optional title.',
