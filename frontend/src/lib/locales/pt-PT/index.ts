export const ptPT = {
  ...
  imageAnalysisPage: {
    ...
    queryPlaceholderRfdetr: "ex.: barco, pessoa, carro — separe as classes por vírgulas, ou deixe vazio para detetar tudo",
    ...
    engineHintRfdetr: "Deteta 80 classes comuns de objetos (pessoa, carro, barco, cão...). Deixe a consulta vazia para detetar tudo, ou liste uma ou mais classes separadas por vírgulas para filtrar — por exemplo: barco, pessoa, camião.",
