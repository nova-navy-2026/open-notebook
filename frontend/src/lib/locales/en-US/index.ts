export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The NNBook API server could not be reached",
  ...
  notebooks: {
    ...
    selectSourcesDesc: "Choose which corpus documents this notebook should use. You can change this later.",
  },
  sources: {
    title: "Sources",
    add: "Add Source",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of NNBook is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  collaboration: {
    ...
    accept: "Accept",
    decline: "Decline",
    joinedNotebook: "You joined the notebook",
