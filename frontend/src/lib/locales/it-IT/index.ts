export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di Marinheiro de Silício non è raggiungibile",
    ...
    docLink: "Documentazione Marinheiro de Silício",
  ...
  sources: {
    ...
    confirmAddToNotebook: "Aggiungi {count} a questo notebook",
  ...
  chat: {
    ...
    messageSources: "Fonti utilizzate",
    deleteMessageDesc: "Eliminare questo messaggio? Eliminando il tuo messaggio viene rimossa anche la risposta dell'assistente. Questa azione non può essere annullata.",
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a Marinheiro de Silício di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di Marinheiro de Silício.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in Marinheiro de Silício",
    missingRequiredModels: "Modelli richiesti mancanti: {models}. Marinheiro de Silício potrebbe non funzionare correttamente senza questi.",
    ...
    visionModelLabel: "Modello Visione",
    visionModelDesc: "Usato per la descrizione di immagini e video - GPT-4o, Claude o Gemini consigliati",
  ...
  apiKeys: {
    ...
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in Marinheiro de Silício.",
