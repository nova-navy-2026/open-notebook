...
const ptPT: PageInfoMap = {
  chat: {
    ...
    items: [
      ...
      '💾 Guardar nota — guarde respostas ou relatórios como nota num workspace com "Save to note".',
  ...
  sources: {
    ...
    items: [
      'Carregue ficheiros, URLs ou texto como novas fontes (a partir de um workspace).',
  ...
  notebooks: {
    title: 'O que pode fazer nos Workspaces',
    description: 'Um workspace é um espaço de trabalho focado que reúne as fontes, as notas e um chat sensível ao contexto sobre um único tema ou operação. Escolhe exatamente que material o assistente pode ver, por isso as respostas mantêm-se fundamentadas no que é importante.',
    items: [
      'Crie um workspace para agrupar as fontes, notas e conversas de um tema; partilhe-o com colegas a partir do cabeçalho.',
      ...
      '🔍 Deep Research — peça uma investigação aprofundada; o agente investiga autonomamente e o relatório fica guardado no workspace.',
      '🖼️ Visual e 🎙️ transcrição — anexe imagens, vídeo ou áudio para detetar ou segmentar objetos, ou para transcrever fala.',
      '💾 Guarde qualquer resposta ou relatório como nota no workspace com "Save to note".',
    ],
  },
  research: {
    ...
    items: [
      ...
      'Guarde os resultados como notas num workspace para reutilização.',
  ...
  visionImage: {
    ...
    items: [
      ...
      'Guarde o resultado como nota de imagem num workspace.',
    ],
  },
  visionVideo: {
  ...
  transcription: {
    ...
    items: [
      ...
      'Use a transcrição como base para notas ou fontes no workspace.',
    ],
  },
}
...
const enUS: PageInfoMap = {
  chat: {
    ...
    items: [
      ...
      '💾 Save note — save answers or reports as a workspace note with "Save to note".',
  ...
  sources: {
    ...
    items: [
      'Upload files, URLs or text as new sources (from inside a workspace).',
  ...
  notebooks: {
    ...
    items: [
      ...
      '🔍 Deep Research — ask for an in-depth investigation; the agent researches autonomously and the report is saved to the workspace.',
      '🖼️ Visual & 🎙️ transcription — attach images, video or audio to detect or segment objects, or to transcribe speech.',
      '💾 Save any answer or report as a note in the workspace with "Save to note".',
    ],
  },
  research: {
    ...
    items: [
      ...
      'Save results as notes in a workspace for reuse.',
  ...
  visionImage: {
    ...
    items: [
      ...
      'Save the result as an image note in a workspace.',
    ],
  },
  visionVideo: {
  ...
  transcription: {
    ...
    items: [
      ...
      'Use the transcription as a basis for notes or sources in a workspace.',
    ],
  },
}
