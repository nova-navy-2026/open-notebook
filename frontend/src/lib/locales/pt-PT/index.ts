export const ptPT = {
  common: {
    ...
    collapse: "Recolher",
    collapseHistory: "Recolher histórico",
    expand: "Expandir",
    ...
    accessibility: {
      ...
      searchNotebooks: "Pesquisar workspaces",
    },
    url: "URL",
  ...
  apiErrors: {
    notebookNotFound: "Workspace não encontrado",
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do Marinheiro de Silício não pôde ser alcançado",
    ...
    docLink: "Documentação do Marinheiro de Silício",
  ...
  notebooks: {
    ...
    deleteNotebook: "Eliminar Workspace",
    deleteNotebookDesc:
    ...
    deleteNotebookExclusiveSources:
      "{count} fonte(s) existem apenas neste workspace.",
    deleteNotebookSharedSources:
      "{count} fonte(s) são compartilhadas com outros workspaces e serão desvinculadas.",
    deleteNotebookNoSources: "Nenhuma fonte neste workspace.",
    deleteExclusiveSourcesLabel: "Eliminar fontes exclusivas",
    keepExclusiveSourcesLabel: "Desvincular e manter",
    activeNotebooks: "Workspaces Ativos",
    archivedNotebooks: "Workspaces Arquivados",
    notFound: "Workspace não encontrado",
    notFoundDesc: "O workspace solicitado não existe.",
    updated: "Atualizado",
    ...
    descPlaceholder: "Adicione mais informações sobre este workspace aqui...",
    createSuccess: "Workspace criado com sucesso",
    updateSuccess: "Workspace atualizado com sucesso",
    deleteSuccess: "Workspace eliminado com sucesso",
    agentNotes: "Colaboração de Agentes",
    backToNotebooks: "Voltar aos workspaces",
    editSources: "Editar fontes",
    selectSources: "Selecionar fontes",
    selectSourcesDesc: "Escolha que documentos do corpus este workspace deve utilizar. Pode alterar mais tarde.",
  },
  sources: {
    title: "Fontes",
    add: "Adicionar Fonte",
    ...
    uploadedSourcesDesc: "Ficheiros, links e texto que adicionou — distintos da Base de Conhecimento acima.",
    noUploadedSourcesYet: "Ainda não há fontes carregadas",
    uploadedSourcesEmptyDesc: "Use “Nova Fonte” para adicionar os seus próprios ficheiros, links ou texto.",
    ...
    filterReady: "Pronto",
    filterProcessing: "A processar",
    filterNotEmbedded: "Não incorporado",
    gridView: "Grelha",
    listView: "Lista",
    noMatchingSources: "Nenhuma fonte corresponde aos filtros",
    showingCount: "A mostrar {count} de {total}",
    cannotSaveNoteNoNotebook:
      "Não é possível guardar nota: ID do workspace não disponível",
    createFirstSource:
    ...
    sourcesAddedToNotebook: "{count} fonte(s) adicionada(s) ao workspace",
    failedToAddSourcesToNotebook: "Falha ao adicionar fontes ao workspace",
    partialAddSuccess:
      "{success} fonte(s) adicionada(s), {failed} falhou(aram)",
    sourceRemovedFromNotebook: "Fonte removida do workspace com sucesso",
    failedToRemoveSourceFromNotebook: "Falha ao remover fonte do workspace",
    removeConfirm: "Tem certeza que deseja remover isto do workspace?",
    ...
    batchCommonSettings:
      "Os mesmos workspaces e transformações serão aplicados a todos os itens.",
    ...
    manageNotebooks: "Gerenciar Workspaces",
    manageNotebooksDesc: "Gerencie quais workspaces contêm esta fonte",
    noNotebooksAvailable: "Nenhum workspace disponível",
    loadFailed: "Falha ao carregar detalhes da fonte",
    removeFromNotebook: "Remover do Workspace",
    retryProcessing: "Tentar Processamento Novamente",
    deleteSource: "Eliminar Fonte",
    retry: "Tentar Novamente",
    addExistingTitle: "Reutilizar uma fonte de outro workspace",
    addExistingDesc:
      "Associe a este workspace uma fonte que já carregou noutro workspace. As fontes que já estão neste workspace não são apresentadas.",
    searchPlaceholder: "Pesquisar fontes por nome ou URL...",
    noNotebooksFound: "Nenhum workspace encontrado.",
    showingFirst100:
  ...
  navyDocs: {
    ...
    selectedTitle: "Documentos selecionados",
    ...
    groupByClassification: "Classificação",
    groupByType: "Tipo",
    groupByNone: "Nenhum",
    ...
    tabChat: "Conversa",
    chatPlaceholder: "Pergunte sobre este documento...",
    chatEmpty: "Faça uma pergunta sobre este documento.",
    chatThinking: "A pensar...",
    chatError: "Não foi possível obter resposta.",
    generatingInsights: "A gerar análises...",
    insightsError: "Não foi possível gerar análises.",
    ...
    notesGraphEmpty:
      "Ainda não há notas para visualizar. Adicione notas a este workspace para ver como se relacionam com os tópicos.",
  ...
  chat: {
    ...
    groupPrevious7Days: "Últimos 7 dias",
    groupPrevious30Days: "Últimos 30 dias",
    ...
    messageSources: "Fontes utilizadas",
    deleteMessageDesc:
      "Eliminar esta mensagem? Ao eliminar a sua mensagem, a resposta do assistente também é removida. Esta ação não pode ser desfeita.",
    ...
    startChat: "Faça qualquer questão para iniciar uma nova conversa",
    askQuestions: "Faça perguntas para entender melhor o conteúdo",
    pressToSend: "Pressione {key} para enviar",
    model: "Modelo",
    createToStart: "Inicie uma conversa para começar.",
    chatWithNotebook: "Conversar com Workspace",
    unableToLoadChat: "Não foi possível carregar o chat",
    noDescription: "Sem descrição",
    startByCreating:
      "Comece a criar seu primeiro workspace para organizar sua pesquisa.",
    ...
    documentsUsed: "Documentos usados nesta conversa",
    contextUsed: "Contexto utilizado",
    contextBasedOn: "Com base em {sources}",
    contextSource: "fonte",
    contextSources: "fontes",
    contextNote: "nota",
    contextNotes: "notas",
    contextDocument: "documento",
    contextDocuments: "documentos",
    regenerate: "Gerar resposta de novo",
    feedbackNotHelpful: "Não gostei da resposta",
    feedbackThanks: "Obrigado — o seu feedback foi enviado ao administrador.",
    exportConversation: "Exportar conversa",
    exportCurrentConversation: "Exportar conversa atual",
    exportAllConversations: "Exportar todas as conversas",
    conversationExported: "Conversa exportada",
    conversationsExported: "Conversas exportadas",
    ...
    visionTrack: "Seguir",
    visionEngine: "Motor",
    analyzeFile: "Analisa este ficheiro.",
  },
  searchPage: {
    askAndSearch: "Perguntar e Pesquisar",
    ...
    ask: "Perguntar",
    processing: "A processar...",
    saveToNotebooks: "Guardar em Workspaces",
    searchDesc:
    ...
    searchSourcesDesc: "Documentos e ficheiros do corpus.",
    searchNotesDesc: "As suas notas guardadas.",
    ...
    searchTypeDescText: "Correspondência exata de palavras-chave.",
    searchTypeDescVector: "Pesquisa semântica por significado.",
    searchTypeDescHybrid: "Combina palavras-chave e significado.",
    recentSearches: "Pesquisas recentes",
    clearRecent: "Limpar",
    groupByType: "Agrupar por tipo",
    searching: "A pesquisar...",
    startSearchingTitle: "Pesquise na sua base de conhecimento",
    startSearchingDesc: "Os resultados respeitam sempre as suas permissões de acesso.",
    notSet: "Não definido",
    saveToNotebook: "Guardar no Workspace",
    saveSuccess: "Guardado no workspace com sucesso",
    saveError: "Falha ao guardar no workspace",
    selectNotebook: "Selecionar Workspace",
  ...
  podcasts: {
    ...
    content: "Conteúdo",
    contentDesc:
      "Escolha workspaces, fontes e notas para incluir neste episódio.",
    itemsSelected: "{count} itens selecionados",
    tokens: "{count} tokens",
    chars: "{count} caracteres",
    loadingNotebooks: "A carregar workspaces...",
    noNotebooksFoundInPodcasts:
      "Nenhum workspace encontrado. Crie um workspace e adicione conteúdo antes de gerar um podcast.",
    ...
    sources: "Fontes",
    notes: "Notas",
    noSources: "Nenhuma fonte disponível neste workspace.",
    noNotes: "Nenhuma nota disponível neste workspace.",
    ...
    noEpisodesYet:
      "Nenhum episódio de podcast ainda. Gere seu primeiro a partir das interfaces de chat de workspace ou fonte.",
  ...
  settings: {
    ...
    filesHelp:
      "Uma vez que seus ficheiros são enviados e processados, eles não são mais necessários. A maioria dos utilizadores deve permitir que o Marinheiro de Silício exclua ficheiros enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do Marinheiro de Silício está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc:
      "Configure quais modelos usar para diferentes propósitos no Marinheiro de Silício",
    missingRequiredModels:
      "Modelos obrigatórios ausentes: {models}. O Marinheiro de Silício pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    ...
    description:
      "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no Marinheiro de Silício.",
  ...
  research: {
    ...
    saveToNotebook: "Guardar no Workspace",
    saveToNotebookDesc:
      "Escolha um workspace para guardar este relatório de pesquisa como nota.",
    selectNotebook: "Selecionar um workspace...",
    save: "Guardar",
    ...
    notebookResearchDesc:
      "Execute uma pesquisa aprofundada e guarde automaticamente o resultado como nota neste workspace.",
  ...
  imageAnalysisPage: {
    ...
    classesLabel: "Classes a detetar",
    classesPlaceholder: "Todas as classes (deixe vazio para detetar tudo)",
    classesSearch: "Procurar classes...",
    classesEmpty: "Nenhuma classe correspondente.",
    classesSelected: "{count} classe(s) selecionada(s)",
    ...
    engineHintRfdetr: "Deteta 80 classes comuns de objetos (pessoa, carro, barco, cão...). Escolha uma ou mais classes para filtrar, ou deixe a seleção vazia para detetar tudo.",
    ...
    analysis: "Análise",
    addToNotebook: "Adicionar ao Workspace",
    download: "Transferir",
  ...
  addToNotebookDialog: {
    ...
    description: "Selecione um ou mais workspaces. O ficheiro será guardado como fonte mas não será usado como contexto da conversa.",
    selectAtLeastOne: "Selecione pelo menos um workspace.",
    noNotebooks: "Sem workspaces disponíveis.",
    cancel: "Cancelar",
    add: "Adicionar",
    adding: "A adicionar...",
    success: "Adicionado ao(s) workspace(s).",
    error: "Não foi possível adicionar ao workspace.",
  },
  transcriptionPage: {
    ...
    reportTypeSummary: "Resumo de reunião (recomendado)",
    reportTypeLiteral: "Transcrição literal",
    generateDocument: "Gerar documento",
    generateDocumentHint: "Gerar um documento a partir da transcrição",
    title: "Transcrição e Diarização",
    subtitle:
      "Carregue uma gravação áudio (ex.: comunicações VHF de navios, reuniões) e converta-a em texto. Opcionalmente identifique quem fala através da diarização de interlocutores.",
    ...
    diarizeHint:
      "Segmenta a gravação por interlocutor para ver quem disse o quê. Pode não estar disponível consoante a configuração do servidor.",
  ...
  collaboration: {
    share: "Partilhar",
    shareNotebook: "Partilhar workspace",
    members: "Membros",
    member: "Membro",
    owner: "Proprietário",
    inviteByEmail: "Convidar por email",
    emailPlaceholder: "nome@marinha.pt",
    sendInvite: "Enviar",
    ...
    revoke: "Revogar",
    remove: "Remover",
    collaborative: "Partilhado",
    notifications: "Convites",
    noInvitations: "Sem convites pendentes",
    invitedYou: "convidou-o a colaborar",
    accept: "Aceitar",
    decline: "Recusar",
    joinedNotebook: "Entrou no workspace",
    joining: "A entrar no workspace…",
