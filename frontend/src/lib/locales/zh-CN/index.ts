export const zhCN = {
  ...
  models: {
    ...
    defaultAssignmentsDesc: "配置用于 NNBook 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有这些模型，NNBook 可能无法正常运行。",
  ...
  apiKeys: {
    ...
    description: "将 API 密钥安全地存储在数据库中，以在 NNBook 中启用 AI 服务商。",
