export const bnIN = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Marinheiro de Silício API সার্ভারে পৌঁছানো যায়নি",
    ...
    docLink: "Marinheiro de Silício ডকুমেন্টেশন",
  ...
  sources: {
    ...
    confirmAddToNotebook: "{count}টি এই নোটবুকে যোগ করুন",
  ...
  chat: {
    ...
    deleteMessageTitle: "বার্তা মুছুন",
    messageSources: "ব্যবহৃত উৎস",
    deleteMessageDesc: "এই বার্তাটি মুছবেন? আপনার বার্তা মুছলে সহকারীর উত্তরও মুছে যাবে। এই কাজটি পুনরায় করা যাবে না।",
  ...
  searchPage: {
    ...
    hybridSearch: "হাইব্রিড অনুসন্ধান",
  ...
  settings: {
    ...
    filesHelp: "একবার আপনার ফাইল আপলোড এবং প্রক্রিয়া হওয়ার পর, সেগুলি আর প্রয়োজন নেই। বেশিরভাগ ব্যবহারকারী Marinheiro de Silício কে আপলোড ফোল্ডার থেকে আপলোড করা ফাইল স্বয়ংক্রিয়ভাবে মুছে ফেলার অনুমতি দিতে পারেন।",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Marinheiro de Silício এর একটি নতুন সংস্করণ উপলব্ধ।",
    upToDate: "আপ টু ডেট",
    unknown: "অজানা",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Marinheiro de Silício জুড়ে বিভিন্ন কাজের জন্য কোন মডেল ব্যবহার করব তা কনফিগার করুন",
    missingRequiredModels: "প্রয়োজনীয় মডেল অনুপস্থিত: {models}। এগুলি ছাড়া Marinheiro de Silício সঠিকভাবে কাজ নাও করতে পারে।",
    ...
    visionModelLabel: "ভিশন মডেল",
    visionModelDesc: "ছবি এবং ভিডিও ক্যাপশনিংয়ের জন্য ব্যবহৃত - GPT-4o, Claude বা Gemini প্রস্তাবিত",
  ...
  apiKeys: {
    ...
    description: "Marinheiro de Silício এ AI প্রোভাইডার সক্ষম করতে ডেটাবেসে নিরাপদভাবে API কী সংরক্ষণ করুন।",
