export const ptPT = {
  ...
  notebooks: {
    ...
    backToNotebooks: "Voltar aos notebooks",
    editSources: "Editar fontes",
    selectSources: "Selecionar fontes",
    selectSourcesDesc: "Escolha que documentos do corpus este notebook deve utilizar. Pode alterar mais tarde.",
  },
  sources: {
    title: "Fontes",
    add: "Adicionar Fonte",
    ...
    retry: "Tentar Novamente",
    addExistingTitle: "Reutilizar uma fonte de outro notebook",
    addExistingDesc:
      "Associe a este notebook uma fonte que já carregou noutro notebook. As fontes que já estão neste notebook não são apresentadas.",
  ...
  collaboration: {
    share: "Partilhar",
    shareNotebook: "Partilhar notebook",
    members: "Membros",
    member: "Membro",
    owner: "Proprietário",
    ...
    accept: "Aceitar",
    decline: "Recusar",
    joinedNotebook: "Entrou no notebook",
    joining: "A entrar no notebook…",
