export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер Marinheiro de Silício недоступен",
    ...
    docLink: "Документация Marinheiro de Silício",
  ...
  sources: {
    ...
    confirmAddToNotebook: "Добавить {count} в этот блокнот",
  ...
  chat: {
    ...
    messageSources: "Использованные источники",
    deleteMessageDesc: "Удалить это сообщение? Удаление вашего сообщения также удалит ответ ассистента. Это действие нельзя отменить.",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить Marinheiro de Silício автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия Marinheiro de Silício.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в Marinheiro de Silício",
    missingRequiredModels: "Отсутствуют необходимые модели: {models}. Marinheiro de Silício может работать некорректно без них.",
    ...
    visionModelDesc: "Используется для описания изображений и видео - рекомендуются GPT-4o, Claude или Gemini",
  ...
  apiKeys: {
    ...
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в Marinheiro de Silício.",
