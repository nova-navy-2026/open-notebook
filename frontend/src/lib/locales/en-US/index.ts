export const enUS = {
  ...
  apiErrors: {
    notebookNotFound: "Workspace not found",
  ...
  connectionErrors: {
    ...
    apiDesc: "The Marinheiro de Silício API server could not be reached",
    ...
    docLink: "Marinheiro de Silício Documentation",
  ...
  notebooks: {
    ...
    deleteNotebookExclusiveSources:
      "{count} source(s) exist only in this workspace.",
    deleteNotebookSharedSources:
      "{count} source(s) are shared with other workspaces and will be unlinked.",
    ...
    backToNotebooks: "Back to workspaces",
    editSources: "Edit sources",
    selectSources: "Select sources",
    selectSourcesDesc: "Choose which corpus documents this workspace should use. You can change this later.",
  },
  sources: {
    title: "Sources",
    add: "Add Source",
    ...
    filterNotEmbedded: "Not embedded",
    gridView: "Grid",
    listView: "List",
    noMatchingSources: "No sources match the filters",
    showingCount: "Showing {count} of {total}",
    cannotSaveNoteNoNotebook: "Cannot save note: workspace ID not available",
    createFirstSource:
    ...
    sourcesAddedToNotebook: "{count} source(s) added to workspace",
    failedToAddSourcesToNotebook: "Failed to add sources to workspace",
    partialAddSuccess: "{success} source(s) added, {failed} failed",
    sourceRemovedFromNotebook: "Source removed from workspace successfully",
    failedToRemoveSourceFromNotebook: "Failed to remove source from workspace",
    removeConfirm: "Are you sure you want to remove this from the workspace?",
    checking: "Checking...",
    ...
    batchCommonSettings:
      "The same workspaces and transformations will be applied to all items.",
    ...
    manageNotebooks: "Manage Workspaces",
    manageNotebooksDesc: "Manage which workspaces contain this source",
    noNotebooksAvailable: "No workspaces available",
    loadFailed: "Failed to load source details",
    removeFromNotebook: "Remove from Workspace",
    retryProcessing: "Retry Processing",
    deleteSource: "Delete Source",
    retry: "Retry",
    addExistingTitle: "Reuse a source from another workspace",
    addExistingDesc:
      "Link a source you already uploaded to another workspace into this one. Sources already in this workspace are not shown.",
    searchPlaceholder: "Search sources by name or URL...",
    noNotebooksFound: "No workspaces found.",
    showingFirst100:
  ...
  navyDocs: {
    ...
    chatEmpty: "Ask a question about this document.",
  ...
  chat: {
    ...
    contextBasedOn: "Based on {sources}",
    ...
    feedbackThanks: "Thanks — your feedback was sent to the administrator.",
  ...
  searchPage: {
    ...
    ask: "Ask",
    processing: "Processing...",
    saveToNotebooks: "Save to Workspaces",
    ...
    searchSourcesDesc: "Documents and corpus files.",
    searchNotesDesc: "Your saved notes.",
    resultsFound: "{count} results found",
    matches: "Matches ({count})",
    noResultsFor: "No results found for “{query}”",
    searchTypeDescText: "Exact keyword matching.",
    searchTypeDescVector: "Semantic search by meaning.",
    searchTypeDescHybrid: "Combines keywords and meaning.",
    recentSearches: "Recent searches",
    clearRecent: "Clear",
    groupByType: "Group by type",
    searching: "Searching...",
    startSearchingTitle: "Search your knowledge base",
    startSearchingDesc: "Results always respect your access permissions.",
    notSet: "Not set",
    saveToNotebook: "Save to Workspace",
    saveSuccess: "Successfully saved to workspace",
    saveError: "Failed to save to workspace",
    selectNotebook: "Select Workspace",
  ...
  podcasts: {
    ...
    content: "Content",
    contentDesc:
      "Pick workspaces, sources, and notes to include in this episode.",
    itemsSelected: "{count} items selected",
    tokens: "{count} tokens",
    chars: "{count} chars",
    loadingNotebooks: "Loading workspaces...",
    noNotebooksFoundInPodcasts:
      "No workspaces found. Create a workspace and add content before generating a podcast.",
    ...
    sources: "Sources",
    notes: "Notes",
    noSources: "No sources available in this workspace.",
    noNotes: "No notes available in this workspace.",
    ...
    noEpisodesYet:
      "No podcast episodes yet. Generate your first one from the workspace or source chat interfaces.",
  ...
  settings: {
    ...
    filesHelp:
      "Once your files are uploaded and processed, they are not required anymore. Most users should allow Marinheiro de Silício to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Marinheiro de Silício is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc:
      "Configure which models to use for different purposes across Marinheiro de Silício",
    missingRequiredModels:
      "Missing required models: {models}. Marinheiro de Silício may not function properly without these.",
  ...
  apiKeys: {
    ...
    description:
      "Store API keys securely in the database to enable AI providers in Marinheiro de Silício.",
  ...
  research: {
    ...
    selectNotebook: "Select a workspace...",
    save: "Save",
  ...
  imageAnalysisPage: {
    ...
    subtitle:
      "Upload an image and ask a question about it. The model will analyze the image and return both a visual result and a text response.",
    ...
    analysis: "Analysis",
    addToNotebook: "Add to Workspace",
    download: "Download",
  ...
  videoTrackingPage: {
    ...
    subtitle:
      "Upload a video and specify which element to track. The model will process the video and return it with the tracked element highlighted.",
    uploadLabel: "Upload Video",
    dropHint: "Drop a video here or click to browse",
    formats: "MP4, MOV, WEBM",
    replaceHint: "Click or drag to replace",
    targetLabel: "Target to track",
    targetPlaceholder: "e.g. red car, person in blue jacket...",
    engineLabel: "Tracking Engine",
  ...
  routePlannerPage: {
    title: "Route Planner",
    subtitle:
      "Compute driving distance and estimated travel time between two locations in Portugal. Powered by OSRM and Nominatim (OpenStreetMap).",
    origin: "Origin",
    originPlaceholder: "e.g. Lisboa, Almada, Base Naval do Alfeite...",
    destination: "Destination",
    destinationPlaceholder: "e.g. Porto, Coimbra, Faro...",
  ...
  addToNotebookDialog: {
    ...
    description:
      "Select one or more workspaces. The file will be saved as a source but will not be used as chat context.",
    selectAtLeastOne: "Select at least one workspace.",
    noNotebooks: "No workspaces found.",
    cancel: "Cancel",
    add: "Add",
    adding: "Adding...",
    success: "Added to workspace(s).",
  ...
  transcriptionPage: {
    ...
    saveToNotebookTitle: "Save transcript to workspace",
    saveToNotebookDescription:
      "Choose a workspace to save the transcript as a note.",
  ...
  collaboration: {
    share: "Share",
    shareNotebook: "Share workspace",
    members: "Members",
    member: "Member",
    owner: "Owner",
    inviteByEmail: "Invite by email",
    emailPlaceholder: "name@marinha.pt",
    sendInvite: "Send",
    ...
    invitedYou: "invited you to collaborate",
    accept: "Accept",
    decline: "Decline",
    joinedNotebook: "You joined the workspace",
